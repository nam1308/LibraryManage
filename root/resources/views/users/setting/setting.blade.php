    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Chọn 2 Kiểu Thanh Bên</p>
        </div>
        <div class="d-flex">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Bạn có thể thay đổi thanh trên qua màn hình hiển thị máy tính. </p>
        <!-- Navbar Fixed -->
        <div class="mt-3 d-flex">
          <h6 class="mb-0">Thanh trên</h6>
