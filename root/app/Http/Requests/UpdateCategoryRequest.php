...
class UpdateCategoryRequest extends FormRequest
{
 /**
    ...
    {
        return [
            'category_cd' => "required|max:20|unique:categories,category_cd,{$this->id},id,deleted_at,NULL",
            'name' => "required|max:50|unique:categories,name,{$this->id},id,deleted_at,NULL",
            'status' => 'required',
            'note' => 'max:255',
        ];
    }
